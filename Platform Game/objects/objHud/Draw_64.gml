...
// No evento Draw GUI do objeto HUD
var _exp_hud_x = 0;
var _exp_hud_y = _get_camera_y - 100; // Posição Y do HUD na tela
...
var _exp_bar_width = 1920; // Largura total da barra de experiência
var _exp_bar_height = 10; // Altura da barra de experiência
