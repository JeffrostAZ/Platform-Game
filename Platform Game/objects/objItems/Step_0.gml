...
if(global.coin > 0 && mouse_check_button_pressed(mb_left)){
	...
	switch(_item){
		...
		case 0:
			...
			objController._shoot_spd = global.items[_item][ATRIBUTES.VELOCIDADE];
	...
	break;
		...
		case 21:
			...
			objPlayer._luk += global.items[_item][ATRIBUTES.SORTE];			
