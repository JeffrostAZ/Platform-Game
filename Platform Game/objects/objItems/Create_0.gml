...
_mult = 0.1;
global.items = [
    ["Laser Rifle", 120, 2001, 1, 6, 5, 5, 10, 30, 25, 15],
    ["Plasma Cannon", 140, 2002, 2, 7, 3, 2, 15, 50, 40, 15],
    ["Quantum Blade", 90, 2003, 3, 8, 5, 10, 20, 20, 35, 15],
    ["Ion Blaster", 100, 2004, 4, 5, 5, 8, 70, 25, 30, 15],
    ["Gravity Hammer", 130, 2005, 5, 9, 5, 3, 30, 40, 50, 30],
    ["Photon Grenade", 80, 2006, 6, 5, 30, 15, 35, 10, 20, 25],
    ["Neutron Gun", 150, 2007, 7, 10, 3, 7, 85, 40, 45, 25],
    ["Antimatter Rifle", 230, 2008, 8, 6, 12, 4, 45, 55, 60, 30],
